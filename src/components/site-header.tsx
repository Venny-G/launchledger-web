...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-50 border-b border-white/8 bg-ink/95">
      <div className="border-b border-white/8 bg-white text-ink">
        <div className="mx-auto max-w-shell px-5 py-2 text-center text-xs font-medium leading-5 sm:px-6 lg:px-8">
          This website is still in development as I&apos;m learning HTML.
        </div>
      </div>
