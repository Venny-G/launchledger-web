  ...
  return (
    <section id="contact" className="py-20 sm:py-24">
      <div className="mx-auto max-w-shell px-6 lg:px-8">
        <div className="rounded-[1.75rem] border border-white/8 bg-panel px-6 py-10 shadow-glow sm:px-10 sm:py-14">
          <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-2xl space-y-4">
              <p className="font-mono text-xs uppercase tracking-[0.34em] text-cyan/75">
                Early access
              </p>
